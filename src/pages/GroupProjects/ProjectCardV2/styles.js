...
export const ProjectCardV2Container = styled(animated.div)`
    display: flex;
    ...
    ${props => {
        if (props.status === 'Ongoing' || props.status === 'Not Started' ){
            return `background: linear-gradient(0.4turn, ${props.theme.white}, ${props.theme.white}, ${props.theme.white}, ${props.theme.white}, ${props.theme.yellowLight}, ${props.theme.yellow});`
            }
        }
    };
    ...
    ${props => {
        if (props.status === 'Completed'){
            return `background: linear-gradient(0.4turn, ${props.theme.white}, ${props.theme.white}, ${props.theme.white}, ${props.theme.white}, ${props.theme.greenBright}, ${props.theme.green});`
            }
        }
    };
    ...
    ${props => {
        if (props.status === 'Not Implemented') {
            return `background: linear-gradient(0.4turn, ${props.theme.white}, ${props.theme.white}, ${props.theme.white}, ${props.theme.white}, ${props.theme.redLight}, ${props.theme.red});`
            }
        }
    };
